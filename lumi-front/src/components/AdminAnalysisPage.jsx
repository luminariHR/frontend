  ...
  return (
    <SidebarProvider>
      <Layout>
        ...
        <div className="overflow-y-auto h-[770px] shadow ">
          <div className="bg-white p-6">
              ...
              <div className="mb-6">
                <div className="mb-2 flex items-center">
                  ...
                  <p className="text-secondary text-xs font-semibold">
                    교정 {applicantData.wrong_num}건
                  </p>
                </div>
                <div
                  className="text-sm border border-gray-200 p-4 rounded-lg "
                  dangerouslySetInnerHTML={{ __html: applicantData.spelling }}
                ></div>
              </div>
            </div>
            ...
            <div className="mb-6">
              <div className="mb-2 flex items-center">
                <div className="text-sm font-semibold mr-2">자소서 원본</div>
              </div>
              <div
                className="text-sm border border-gray-200 p-4 rounded-lg "
                dangerouslySetInnerHTML={{ __html: applicantData.content }}
              ></div>
            </div>
